...
const ListShipment : React.FC= () => {
  ...
  <dd
    className={`mt-1.5 text-base font-semibold ${
      Ship.healthCheckStatus === 'Passed'
        ? 'text-green-500 dark:text-green-400'
        : Ship.healthCheckStatus === 'Failed'
  ...
  >
    <a href="#" className="hover:underline">{Ship.healthCheckStatus}</a>
       ...
       <dl className="w-1/2 sm:w-1/6 lg:w-auto lg:flex-1">
         ...
         <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">{Ship.packingStatus}</dd>
       </dl>

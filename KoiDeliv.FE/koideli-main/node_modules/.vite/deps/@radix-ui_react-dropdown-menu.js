...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-I2WUOFYZ.js";
import {
  createCollection,
  useDirection
} from "./chunk-6G3WGJDP.js";
import {
  Slot
} from "./chunk-KJLSMPW6.js";
import {
  require_jsx_runtime
...
function useComposedRefs2(...refs) {
  return React18.useCallback(composeRefs3(...refs), refs);
}
...
function createContextScope3(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    function useContext22(consumerName, scope) {
      const Context = (scope == null ? void 0 : scope[scopeName][index]) || BaseContext;
      const context = React19.useContext(Context);
      if (context)
        return context;
      if (defaultContext !== void 0)
        return defaultContext;
...
var useLayoutEffect22 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React22.useLayoutEffect : () => {
};

// node_modules/@radix-ui/react-popper/node_modules/@radix-ui/react-use-size/dist/index.mjs
var React23 = __toESM(require_react(), 1);
function useSize(element) {
  const [size2, setSize] = React23.useState(void 0);
  useLayoutEffect22(() => {
    if (element) {
...
var PopperAnchor = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime11.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var PopperContent = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React24.useState(null);
...
var Portal = React25.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime12.jsx)(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var RemoveScroll = React28.forwardRef(function(props, parentRef) {
  ...
  return React28.createElement(
    React28.Fragment,
    null,
    enabled && React28.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React29.useState(styleSingleton)[0];
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React31.useRef(false);
  ...
  return (0, import_jsx_runtime13.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime13.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime13.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React31.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React31.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(Collection.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime13.jsx)(Collection.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime13.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime13.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
var MenuRootContentModal = React31.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React31.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime13.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React31.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React31.useState(null);
    const contentRef = React31.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React31.useRef(0);
    const searchRef = React31.useRef("");
    const pointerGraceTimerRef = React31.useRef(0);
    const pointerGraceIntentRef = React31.useRef(null);
    const pointerDirRef = React31.useRef("right");
    const lastPointerXRef = React31.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React31.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React31.useCallback((event) => {
      var _a, _b;
    ...
    return (0, import_jsx_runtime13.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React31.useCallback(
          (event) => {
        ...
        onItemLeave: React31.useCallback(
          (event) => {
            var _a;
            if (isPointerMovingToSubmenu(event))
              return;
        ...
        onPointerGraceIntentChange: React31.useCallback((intent) => {
...
var MenuGroup = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...groupProps } = props;
    return (0, import_jsx_runtime13.jsx)(Primitive2.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
MenuGroup.displayName = GROUP_NAME;
var LABEL_NAME = "MenuLabel";
var MenuLabel = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...labelProps } = props;
    return (0, import_jsx_runtime13.jsx)(Primitive2.div, { ...labelProps, ref: forwardedRef });
  }
);
MenuLabel.displayName = LABEL_NAME;
var ITEM_NAME = "MenuItem";
var ITEM_SELECT = "menu.itemSelect";
var MenuItem = React31.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React31.useState("");
    React31.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React31.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React31.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React31.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React31.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React31.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React31.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React31.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React31.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React31.useCallback(() => {
      if (openTimerRef.current)
        window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React31.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React31.useEffect(() => {
...
var MenuSubContent = React31.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
    ...
    const ref = React31.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime13.jsx)(Collection.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime13.jsx)(Collection.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime13.jsx)(
      MenuContentImpl,
      {
...
var useLayoutEffect23 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React32.useLayoutEffect : () => {
};

// node_modules/@radix-ui/react-dropdown-menu/node_modules/@radix-ui/react-id/dist/index.mjs
var useReactId2 = React33["useId".toString()] || (() => void 0);
var count3 = 0;
function useId2(deterministicId) {
  const [id, setId] = React33.useState(useReactId2());
  useLayoutEffect23(() => {
    if (!deterministicId)
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime14.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime14.jsx)(Root3, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
